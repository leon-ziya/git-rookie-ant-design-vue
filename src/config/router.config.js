...
export const constantRouterMap = [
  ...
  // {
  //   path: '/DashChart',
  //   component: () => import(/* webpackChunkName: "fail" */ '@/views/bigscreen/DashChart')
  // },
  //
  // {
  //   path: '/DashStatistics',
  //   component: () => import(/* webpackChunkName: "fail" */ '@/views/bigscreen/DashStatistics')
  // },
  //
  // {
  //   path: '/DashVideo',
  //   component: () => import(/* webpackChunkName: "fail" */ '@/views/bigscreen/DashVideo')
  // },
